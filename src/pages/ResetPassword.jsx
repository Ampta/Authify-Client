...
const ResetPassword = () => {
    ...
    return (
        <div className="d-flex align-items-center justify-content-center vh-100 position-relative"
            ...
            {/* Reset Password card */}
            {!isEmailSent && (
                <div className="rounded-4 p-5 text-center bg-white" style={{ maxWidth: "400px", width: "100%" }}>
            ...
            {/* New Password From */}
            {isOtpSubmitted && isEmailSent && (
                <div className="rounded-4 p-4 text-center bg-white" style={{ maxWidth: "400px", width: "100%" }}>
                    <h4>New Password</h4>
                    <p className="mb-4">Enter the password below</p>
